	...
	<div class="content-wrapper">
			...
			<div class="alert bg-primary text-white alert-dismissible fade show rounded-0 mb-0 text-lg-center" role="alert">
				<div class="container">
					<div class="alert-inner p-0">
						<span class="badge badge-lg bg-white text-primary text-uppercase rounded me-2">Update</span> New version of our product is finally <a href="#" class="alert-link link-white hover"> here</a>!
					</div>
					<!-- /.alert-inner -->
				</div>
				<!-- /.container -->
            ...
            <nav class="navbar navbar-expand-lg center-nav transparent navbar-light">
                <div class="container flex-lg-row flex-nowrap align-items-center">
                  <div class="navbar-brand w-100">
                    <a href="./index.html">
                      <img src="{{ asset('template/assets/img/logo-dark.png')}}" srcset="{{ asset('template/assets/img/logo-dark@2x.png 2x') }}" alt="" />
                    </a>
                  </div>
                  ...
                  <div class="navbar-other w-100 d-flex ms-auto">
                    <ul class="navbar-nav flex-row align-items-center ms-auto">
                      <li class="nav-item dropdown language-select">
                        <a class="nav-link dropdown-item dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Nama Pemain</a>
		...
		<section class="wrapper bg-soft-primary">
            <div class="container pt-5 pb-15 py-lg-17 py-xl-19 pb-xl-20 position-relative">
              <img class="position-lg-absolute col-12 col-lg-10 col-xl-11 col-xxl-10 px-lg-5 px-xl-0 ms-n5 ms-sm-n8 ms-md-n10 ms-lg-0 mb-md-4 mb-lg-0" src="{{ asset('template/assets/img/photos/devices.png') }}" srcset="{{ asset('template/assets/img/photos/devices@2x.png 2x') }}" data-cue="fadeIn" alt="" style="top: -1%; left: -21%; animation-name: fadeIn;
		...
		<section class="wrapper bg-light">
			<div class="container py-14 py-md-17">
				...
				<div class="row gx-lg-8 gx-xl-12 gy-8 mb-14 mb-md-17" data-cues="slideInUp" data-group="services">
					<div class="col-md-6 col-lg-4">
						<div class="d-flex flex-row">
							<div>
								<img src="{{ asset('template/assets/img/icons/lineal/target.svg') }}" class="svg-inject icon-svg icon-svg-sm text-aqua me-4" alt="" />
							</div>
							<div>
					...
					<div class="col-md-6 col-lg-4">
						<div class="d-flex flex-row">
							<div>
								<img src="{{ asset('template/assets/img/icons/lineal/medal.svg') }}" class="svg-inject icon-svg icon-svg-sm text-yellow me-4" alt="" />
							</div>
							<div>
					...
					<div class="col-md-6 col-lg-4">
						<div class="d-flex flex-row">
							<div>
								<img src="@@webRoot/assets/img/icons/lineal/clock-3.svg" class="svg-inject icon-svg icon-svg-sm text-red me-4" alt="" />
							</div>
							<div>
					...
					<div class="col-md-6 col-lg-4">
						<div class="d-flex flex-row">
							<div>
								<img src="@@webRoot/assets/img/icons/lineal/check.svg" class="svg-inject icon-svg icon-svg-sm text-pink me-4" alt="" />
							</div>
							<div>
					...
					<div class="col-md-6 col-lg-4">
						<div class="d-flex flex-row">
							<div>
								<img src="@@webRoot/assets/img/icons/lineal/shop-2.svg" class="svg-inject icon-svg icon-svg-sm text-green me-4" alt="" />
							</div>
							<div>
					...
					<div class="col-md-6 col-lg-4">
						<div class="d-flex flex-row">
							<div>
								<img src="@@webRoot/assets/img/icons/lineal/team.svg" class="svg-inject icon-svg icon-svg-sm text-purple me-4" alt="" />
							</div>
							<div>
				...
				<div class="row gx-lg-8 gx-xl-10 mb-lg-19 mb-xl-22 align-items-center">
					<div class="col-lg-6">
						<figure><img src="@@webRoot/assets/img/photos/device.png" srcset="@@webRoot/assets/img/photos/device@2x.png 2x" data-cue="fadeIn" alt="" /></figure>
					</div>
					<!-- /column -->
					<div class="col-lg-6">
						...
						<div class="row gy-6 gx-xxl-8 process-wrapper" data-cues="slideInUp" data-group="process">
							<div class="col-md-4"> <img src="@@webRoot/assets/img/icons/lineal/cloud-computing.svg" class="svg-inject icon-svg icon-svg-sm text-green mb-3" alt="" />
								<h4 class="mb-1">1. Download</h4>
								<p class="mb-0">Nulla vitae elit libero elit non porta eget.</p>
							</div>
							<!--/column -->
							<div class="col-md-4"> <img src="@@webRoot/assets/img/icons/lineal/smartphone-2.svg" class="svg-inject icon-svg icon-svg-sm text-red mb-3" alt="" />
								<h4 class="mb-1">2. Set Profile</h4>
								<p class="mb-0">Nulla vitae elit libero elit non porta eget.</p>
							</div>
							<!--/column -->
							<div class="col-md-4"> <img src="@@webRoot/assets/img/icons/lineal/rocket.svg" class="svg-inject icon-svg icon-svg-sm text-aqua mb-3" alt="" />
				...
				<div class="row">
					<div class="col-xl-10 mx-auto">
						<div class="mt-lg-n20 mt-xl-n22 mb-14 mb-md-16 position-relative" data-cue="slideInUp">
							<a href="@@webRoot/assets/media/movie.mp4" class="btn btn-circle btn-primary btn-play ripple mx-auto mb-5 position-absolute" style="top:50%; left: 50%; transform: translate(-50%,-50%); z-index:3;" data-glightbox><i class="icn-caret-right"></i></a>
							<figure class="rounded shadow"><img src="@@webRoot/assets/img/photos/v1.jpg" srcset="@@webRoot/assets/img/photos/v1@2x.jpg 2x" alt=""></figure>
						</div>
											...
											<div class="card-body">
												...
												<blockquote class="icon mb-0">
													...
													<div class="blockquote-details">
														<img class="rounded-circle w-12" src="@@webRoot/assets/img/avatars/te7.jpg" srcset="@@webRoot/assets/img/avatars/te7@2x.jpg 2x" alt="" />
														<div class="info">
										...
										<div class="card">
											<div class="card-body">
												...
												<blockquote class="icon mb-0">
													<p>“Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Vestibulum id ligula porta felis euismod semper. Cras justo odio dapibus facilisis sociis natoque.”</p>
													<div class="blockquote-details">
														<img class="rounded-circle w-12" src="@@webRoot/assets/img/avatars/te8.jpg" srcset="@@webRoot/assets/img/avatars/te8@2x.jpg 2x" alt="" />
														<div class="info">
										...
										<div class="card">
											<div class="card-body">
												...
												<blockquote class="icon mb-0">
													<p>“Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Vestibulum id ligula porta felis euismod semper. Cras justo odio dapibus facilisis sociis natoque.”</p>
													<div class="blockquote-details">
														<img class="rounded-circle w-12" src="@@webRoot/assets/img/avatars/te9.jpg" srcset="@@webRoot/assets/img/avatars/te9@2x.jpg 2x" alt="" />
														<div class="info">
										...
										<div class="card">
											<div class="card-body">
												...
												<blockquote class="icon mb-0">
													<p>“Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Vestibulum id ligula porta felis euismod semper. Cras justo odio dapibus facilisis sociis natoque.”</p>
													<div class="blockquote-details">
														<img class="rounded-circle w-12" src="@@webRoot/assets/img/avatars/te10.jpg" srcset="@@webRoot/assets/img/avatars/te10@2x.jpg 2x" alt="" />
														<div class="info">
															<h5 class="mb-0">Coriss Ambady</h5>
															<p class="mb-0">Financial Analyst</p>
														</div>
										...
										<div class="card">
											<div class="card-body">
												...
												<blockquote class="icon mb-0">
													<p>“Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Vestibulum id ligula porta felis euismod semper. Cras justo odio dapibus facilisis sociis natoque.”</p>
													<div class="blockquote-details">
														<img class="rounded-circle w-12" src="@@webRoot/assets/img/avatars/te11.jpg" srcset="@@webRoot/assets/img/avatars/te11@2x.jpg 2x" alt="" />
														<div class="info">
										...
										<div class="card">
											<div class="card-body">
												...
												<blockquote class="icon mb-0">
													<p>“Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Vestibulum id ligula porta felis euismod semper. Cras justo odio dapibus facilisis sociis natoque.”</p>
													<div class="blockquote-details">
														<img class="rounded-circle w-12" src="@@webRoot/assets/img/avatars/te12.jpg" srcset="@@webRoot/assets/img/avatars/te12@2x.jpg 2x" alt="" />
														<div class="info">
		...
		<section class="wrapper bg-soft-primary">
			<div class="container pt-10 pb-15 py-lg-17 py-xl-20 py-xxl-22 position-relative">
				<img class="position-lg-absolute col-12 col-lg-12 mt-lg-n50p mb-3 mb-md-10 mb-lg-0" src="@@webRoot/assets/img/photos/devices2.png" srcset="@@webRoot/assets/img/photos/devices2@2x.png 2x" data-cue="fadeIn" alt="" style="top: 50%; left: -23%;" />
                        ...
                        <section>
                            <div class="cotainer-fluid my-5">
                                ...
                                <div class="owl-carousel owl-theme mt-2">
                                    ...
                                    <div class="item">
                                        <div class="card border-0 shadow">
                                            <img src="{{ asset('asset/img/kartu-bridge-custom-wajik-12.png')}}" class="card-img-top">
                                        </div>
                                        <h6>2</h6>
                                    </div>
                                    <!-- item ends -->
                                    ...
                                    <div class="item">
                                        <div class="card border-0 shadow">
                                            <img src="{{ asset('asset/img/kartu-bridge-custom-wajik-13.png')}}" class="card-img-top">
                                        </div>
                                        <h6>3</h6>
                                    </div>
                                    <!-- item ends -->
                                    ...
                                    <div class="item">
                                        <div class="card border-0 shadow">
                                            <img src="{{ asset('asset/img/kartu-bridge-custom-wajik-14.png')}}" class="card-img-top">
                                        </div>
                                        <h6>4</h6>
                                    </div>
                                    <!-- item ends -->
                                    ...
                                    <div class="item">
                                        <div class="card border-0 shadow">
                                            <img src="{{ asset('asset/img/kartu-bridge-custom-wajik-09.png')}}" class="card-img-top">
                                        </div>
                                        <h6>5</h6>
                                    </div>
                                    <!-- item ends -->
                                    ...
                                    <div class="item">
                                        <div class="card border-0 shadow">
                                            <img src="{{ asset('asset/img/kartu-bridge-custom-wajik-10.png')}}" class="card-img-top">
                                        </div>
                                        <h6>6</h6>
                                    </div>
                                    <!-- item ends -->
                        ...
                        <section>
                            <div class="cotainer-fluid my-5">
                                ...
                                <div class="owl-carousel owl-theme mt-2">
                                    <div class="item">
                                        <div class="card border-0 shadow">
                                            <img src="{{ asset('asset/img/kartu-bridge-custom-wajik-06.png')}}" class="card-img-top">
                                        </div>
                                        <h6>1</h6>
                                    </div>
                                    <!-- item ends -->
                                    ...
                                    <div class="item">
                                        <div class="card border-0 shadow">
                                            <img src="{{ asset('asset/img/kartu-bridge-custom-wajik-07.png')}}" class="card-img-top">
                                        </div>
                                        <h6>2</h6>
                                    </div>
                                    <!-- item ends -->
                                    ...
                                    <div class="item">
                                        <div class="card border-0 shadow">
                                            <img src="{{ asset('asset/img/kartu-bridge-custom-wajik-08.png')}}" class="card-img-top">
                                        </div>
                                        <h6>3</h6>
                                    </div>
                                    <!-- item ends -->
