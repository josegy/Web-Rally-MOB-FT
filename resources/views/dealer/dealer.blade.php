                        ...
                        $('#listUtuh')
                            .trigger('add.owl.carousel', [
                                `<div class="item">
                                    ...
                                    <label class="fs-20 text-dark">${data.utuh[key].namaKartu.replace('_', '').replace('wajik', '<span class="text-red">♦</span>').replace('keriting', '♣').replace('love', '<span class="text-red">♥</span>').replace('waru', '♠')}</label>
                                    </div>`
